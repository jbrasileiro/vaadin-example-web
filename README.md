...
- vaadin-example-web-addon: addon module, custom server and client side code 
- vaadin-example-web-ui: main application module
- vaadin-example-web-backend: backend module, contains any server side java code and dependencies
